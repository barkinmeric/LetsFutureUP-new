<template>
	<section class="startup">
		<social-head :title="$t('startup.title')" :description="$t('startup.desc')" />
		<div class="container">
...
export default {
	head() {
		return {
			title: `Let's FutureUP ${this.$i18n.t("startup.title")} ${this.$i18n.t("url")}`,
			meta: [
				{
					hid: "description",
					name: "description",
					content: this.$i18n.t("startup.desc"),
				},
			],
		};
	},
